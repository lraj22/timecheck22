	...
	return (
		<details className="division">
			<summary>
				...
				<input type="text" value={thisDivision.division_id} name="divisionId" onChange={e => setDivisionId(e.target.value)} />
			</summary>
			...
			<div title="Visible to users when selecting their division">
				...
				<input type="text" value={thisDivision.division_label} name="divisionId" onChange={e => setDivisionLabel(e.target.value)} /><br /><br />
			</div>
