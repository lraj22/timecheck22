/** @license
 * Slightly adapted to fit my uses :] - Lakshya Raj
 * -----------------------------------------------------------
...
let snowStorm = (function(window, document) {
  ...
  let snowEl = document.getElementById("snow");
  ...
  this.snowColor = '#0875dc';        // Don't eat (or use?) yellow snow.
  this.snowCharacter = '❄';  // &bull; = bullet, &middot; is square on some systems etc.
  this.snowStick = true;          // Whether or not snow should "stick" at the bottom. When off, will never collect.
  this.targetElement = snowEl || null;      // element which snow will be appended to (null = document.body) - can be an element ID eg. 'myDiv', or a DOM node reference
...
}).call({}, window, document); // set this to {} to avoid polluting global namespace
