...
- Select your school (if available)
...
**Dependencies**: localforage for local data storage purposes, Luxon for manipulating date/time values, React for the context editor page, and Quill for the notes widget
...
Questions for me? Any suggestions for this SRS? You can [contact me directly][contact_form] or post an issue on the [GitHub repo][repo].

[repo]: https://github.com/lraj22/timecheck22
[lraj22]: https://github.com/lraj22
[contact_form]: https://docs.google.com/forms/d/e/1FAIpQLSdDwXGHj7Dz2Z-A-Cd2TxkxPCrW-v_WEo0hrDyh7z21zLTlIg/viewform
